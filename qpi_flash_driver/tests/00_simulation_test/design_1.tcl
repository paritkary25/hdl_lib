...
proc create_root_design { parentCell } {
  ...
  if { [catch {set flash_axis_qspi_adap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [list \
    CONFIG.CLK_FREQ_MHz {10} \
    CONFIG.CS_SET_WAIT {4} \
    CONFIG.DEBUG {true} \
    CONFIG.QPI_FREQ_DIV {2} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins flash_axis_qspi_adap_0/s00_axi]
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_pins microblaze_0/M0_AXIS] [get_bd_intf_pins flash_axis_qspi_adap_0/s00_axis]
  ...
  connect_bd_net -net reset_rtl_1  [get_bd_ports nreset_rtl] \
  ...
  assign_bd_address -offset 0x00020000 -range 0x00001000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs flash_axis_qspi_adap_0/s00_axi/reg0] -force
